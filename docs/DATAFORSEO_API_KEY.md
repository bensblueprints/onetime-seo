...
OneTime SEO uses [DataForSEO](https://dataforseo.com/) to fetch SEO data. It's a pay-as-you-go third-party service unaffiliated with OneTime SEO. You need an API key to connect OneTime SEO to it.
