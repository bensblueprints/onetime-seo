...
function firstPrompts(domain: string | null): string[] {
  ...
  return [
    `Review ${site}. Ideas for what keywords we could target? Use OneTime SEO`,
    "Research my competitors top pages and keywords and tell me what's working. Use OneTime SEO",
  ];
}
        ...
        {connected ? (
          ...
          <>
            <div className="space-y-2 text-sm text-base-content/70">
              <p>
                OneTime SEO is designed to give your AI agent the data it needs to
