...
export const AUDIT_ISSUE_TYPES = {
  "blocked-page": {
    ...
    howToFix:
      'If you own this site, allowlist the "OneTimeSEO-Audit" user agent in your WAF/bot-protection settings (on Cloudflare: a WAF custom rule that skips bot protection when the user agent contains "OneTimeSEO-Audit"; on some free tiers you may need to relax bot protection). Then re-run the audit.',
  },
  "server-error": {
    severity: "critical",
